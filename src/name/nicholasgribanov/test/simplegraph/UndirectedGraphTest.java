...
public class UndirectedGraphTest {
    ...
    public void setUp() throws Exception {
        stringGraph = new UndirectedGraph<>();
        integerGraph = new UndirectedGraph<>();
    ...
    public void getPathString() throws PathNotFoundException, VertexNotFoundException {
        ...
        List<Edge<String>> expected = List.of(
                new Edge<>(new Vertex<>("D"), new Vertex<>("E")),
                new Edge<>(new Vertex<>("E"), new Vertex<>("C")),
                new Edge<>(new Vertex<>("C"), new Vertex<>("A"))
        );
